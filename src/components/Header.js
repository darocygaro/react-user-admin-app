...
import logo from '../images/upm_logout.png'
                            ...
                            <nav className="an-primary-links">
                                <ul className="an-primary-links__list">
                                    <li className="an-primary-links__list-item an-primary-links__list-item--home">
                                        <a href="#/home" className="an-primary-links__link">
                                ...
                                <div style={{ float: "right", width: "50px", height: "50px" }}>
                                    <a href="#" target="_self" className="an-primary-links__link">
                                        <img style={{ width: "30px", height: "30px", marginTop: "10px" }} src={logo} alt=""></img>
                                    </a>
                                </div>
                            </nav>
                        </div>
